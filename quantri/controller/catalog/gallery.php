...
class ControllerCataloggallery extends Controller {
	...
	public function repair() {
		...
		if ($this->validateRepair()) {
			$this->model_catalog_gallery->repairgallery();

			$this->session->data['success'] = $this->language->get('text_success');

			$this->response->redirect($this->url->link('catalog/gallery', 'token=' . $this->session->data['token'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['repair'] = $this->url->link('catalog/gallery/repair', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$data['gallerys'][] = array(
				...
				'delete'      => $this->url->link('catalog/gallery/delete', 'token=' . $this->session->data['token'] . '&gallery_id=' . $result['gallery_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_sort_order'] = $this->url->link('catalog/gallery', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
