...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
		...
		} elseif (!empty($information_info['bottom'])) {
		...
		} elseif (!empty($information_info['bottom2'])) {
			$data['bottom2'] = $information_info['bottom2'];
		} else {
			$data['bottom2'] = 0;
		}

		if (isset($this->request->post['bottom3'])) {
			$data['bottom3'] = $this->request->post['bottom3'];
		} elseif (!empty($information_info['bottom3'])) {
			$data['bottom3'] = $information_info['bottom3'];
		} else {
			$data['bottom3'] = 0;
		}
