...
class ControllerCommonMenu extends Controller {
	...
	public function index() {
		...
		$data['booking'] = $this->url->link('catalog/booking', 'token=' . $this->session->data['token'], 'SSL');


		$data['video'] = $this->url->link('catalog/video', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['slideshow'] = $this->url->link('module/slideshow', 'token=' . $this->session->data['token'], 'SSL');
