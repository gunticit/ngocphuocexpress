...
class ControllerCommonControlpanel extends Controller {
	public function index() {
		...
		$data['customer1'] = $this->url->link('customer/customer', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['form'] = $this->url->link('module/xform', 'token=' . $this->session->data['token'], 'SSL');
