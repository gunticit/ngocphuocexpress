...
class ControllerCommonCaptcha extends Controller {
	public function index($error = array()) {
		$this->load->language('common/captcha');
		...
		if (file_exists(DIR_TEMPLATE . 'common/captcha.tpl')) {
			return $this->load->view('common/captcha.tpl', $data);
		} else {
			return $this->load->view('common/captcha.tpl', $data);
		}
	}
	...
	public function captcha() {
		...
		imagefilledrectangle($image, 0, ($height/2), $width, ($height/2), $black);
