...
class ControllerModuleBrainyFilter extends Controller {
    ...
    public function __construct($registry) {
        ...
        $this->model = new ModelModuleBrainyFilter($this->registry);
    }
    ...
    public function install() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '>=')) {
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/product/addProduct/after', 'module/brainyfilter/eventEditProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/product/editProduct/after', 'module/brainyfilter/eventEditProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/product/deleteProduct/after', 'module/brainyfilter/eventDeleteProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/review/addReview/after', 'module/brainyfilter/eventEditReview');
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/review/editReview/after', 'module/brainyfilter/eventEditReview');
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/review/deleteReview/after', 'module/brainyfilter/eventEditReview');
        } else {
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.product.add', 'module/brainyfilter/eventEditProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.product.edit', 'module/brainyfilter/eventEditProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.product.delete', 'module/brainyfilter/eventDeleteProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.review.add', 'module/brainyfilter/eventEditReview');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.review.edit', 'module/brainyfilter/eventEditReview');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.review.delete', 'module/brainyfilter/eventEditReview');
        }
    }
    ...
    {
        $productId = $this->_eventHelperGetIdArg(func_get_args());
    ...
    public function eventEditReview()
    {
        $reviewId = $this->_eventHelperGetIdArg(func_get_args());
        $this->load->model('catalog/review');
        $review = $this->model_catalog_review->getReview($reviewId);
        $this->model->cacheProductProperties($review['product_id']);
    }
    
    protected function _eventHelperGetIdArg($args) {
        $id = null;
        if (count($args) > 1) {
            $id = (is_null($args[1])) ? $args[2] : $args[1];
        } elseif (count($args) == 1) {
            $id = $args[0];
        }
        return $id;
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['bf'])) {
            ...
            if ($this->_validate($post)) {
                ...
                if ($this->request->post['action'] == 'apply') {
                    $this->response->redirect($this->url->link('module/brainyfilter', 'token=' . $this->session->data['token'] . '&module_id=' . $moduleId, 'SSL'));
                } else {
        ...
        $this->_data['instanceUrl'] = $this->url->link('module/brainyfilter', 'token=' . $this->session->data['token'] . '&module_id=', 'SSL');
        ...
        $this->_data['removeInstanceAction'] = $this->url->link('module/brainyfilter/removeInstance', 'token=' . $this->session->data['token'] . '&module_id=' . $moduleId, 'SSL');
