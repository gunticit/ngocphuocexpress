...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->request->post['config_error_filename'] = 'php-error.log';
		...
		$data['entry_first_time'] = $this->language->get('entry_first_time');
		...
		if (isset($this->request->post['config_address2'])) {
			...
			$data['config_address2'] = $this->config->get('config_address2', true);
		}

		if (isset($this->request->post['config_gpcn'])) {
			$data['config_gpcn'] = $this->request->post['config_gpcn'];
		} else {
			$data['config_gpcn'] = $this->config->get('config_gpcn', true);
		}
		...
		if (isset($this->request->post['config_hotline'])) {
			...
			$data['config_hotline'] = $this->config->get('config_hotline', true);
		...
		if (isset($this->request->post['config_welcome'])) {
			...
			$data['config_welcome'] = $this->request->post['config_welcome'];

		} else {

			$data['config_welcome'] = $this->config->get('config_welcome', true);
		...
		if (isset($this->request->post['config_about_us'])) {
			...
			$data['config_about_us'] = $this->config->get('config_about_us', true);

		}

		if (isset($this->request->post['config_tamnhin'])) {

			$data['config_tamnhin'] = $this->request->post['config_tamnhin'];

		} else {

			$data['config_tamnhin'] = $this->config->get('config_tamnhin', true);

		}

		if (isset($this->request->post['config_sumenh'])) {

			$data['config_sumenh'] = $this->request->post['config_sumenh'];

		} else {

			$data['config_sumenh'] = $this->config->get('config_sumenh', true);

		}

		if (isset($this->request->post['config_gtcl'])) {

			$data['config_gtcl'] = $this->request->post['config_gtcl'];

		} else {

			$data['config_gtcl'] = $this->config->get('config_gtcl', true);
		...
		if (isset($this->request->post['config_logoft'])) {

			$data['config_logoft'] = $this->request->post['config_logoft'];

		} else {

			$data['config_logoft'] = $this->config->get('config_logoft');
		...
		if (isset($this->request->post['config_logoft']) && is_file(DIR_IMAGE . $this->request->post['config_logoft'])) {

			$data['logoft'] = $this->model_tool_image->resize($this->request->post['config_logoft'], 100, 100);

		} elseif ($this->config->get('config_logoft') && is_file(DIR_IMAGE . $this->config->get('config_logoft'))) {

			$data['logoft'] = $this->model_tool_image->resize($this->config->get('config_logoft'), 100, 100);

		} else {

			$data['logoft'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		...
		if (isset($this->request->post['config_first_time'])) {

			$data['config_first_time'] = $this->request->post['config_first_time'];

		} else {

			$data['config_first_time'] = $this->config->get('config_first_time');
	...
	protected function validate() {
		...
		foreach($languages as $language) {
			...
			if ((utf8_strlen($this->request->post['config_telephone'][$language_id]) < 3) || (utf8_strlen($this->request->post['config_telephone'][$language_id]) > 135)) {
