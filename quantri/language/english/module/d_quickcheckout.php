...
$_['entry_general_trigger']	=	'Payment Triggers';
...
$_['help_position_module']	=	'If you want the AQC to show up in other locations, then you can use this option. If you just want to replace the main checkout - then do not use this option and use the option "Replace main checkout"';
