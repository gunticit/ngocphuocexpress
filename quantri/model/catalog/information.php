...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', bottom2 = '" . (isset($data['bottom2']) ? (int)$data['bottom2'] : 0) . "', bottom3 = '" . (isset($data['bottom3']) ? (int)$data['bottom3'] : 0) . "', status = '" . (int)$data['status'] . "'");
		...
		if (!empty($data['keyword'])) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'information_id=" . (int)$information_id . "', keyword = '" . $this->db->escape(seo_alias($data['information_description'][$language_id]['title'])) . "'");
		}
	...
	public function editInformation($information_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', bottom2 = '" . (isset($data['bottom2']) ? (int)$data['bottom2'] : 0) . "', bottom3 = '" . (isset($data['bottom3']) ? (int)$data['bottom3'] : 0) . "', status = '" . (int)$data['status'] . "' WHERE information_id = '" . (int)$information_id . "'");
