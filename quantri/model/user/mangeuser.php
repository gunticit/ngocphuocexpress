<?php
class ModelUserMangeuser extends Model {
	...
	public function getMaxUserGroups() {
		$query = $this->db->query("SELECT MAX(user_group_id) AS user_group_id FROM `" . DB_PREFIX . "user_group`");
	...
	public function getUserpostpermission($user_id) {
