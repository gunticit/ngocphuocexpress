! function(e) {
    window.elFinder = function(t, n) {
            ...
            var i, r, a, o = this,
                ...
                z = "auto",
                I = 400,
                P = e(document.createElement("audio")).hide().appendTo("body")[0],
                M = function(t) {
                    if (t.init) y = {};
                    else
                        for (var n in y) y.hasOwnProperty(n) && "directory" != y[n].mime && y[n].phash == g && -1 === e.inArray(n, C) && delete y[n];
                    g = t.cwd.hash, A(t.files), y[g] || A([t.cwd]), o.lastDir(g)
                },
                A = function(e) {
                ...
                D = function(t) {
                    ...
                    f && (e.each(x, function(e, r) {
                        r.type == t.type && r.keyCode == n && r.shiftKey == t.shiftKey && r.ctrlKey == i && r.altKey == t.altKey && (t.preventDefault(), t.stopPropagation(), r.callback(t, o), o.debug("kamensharlandjiev-exec", e + " : " + r.description))
            ...
            return this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = -1 !== navigator.userAgent.indexOf("Mac") ? "mac" : -1 !== navigator.userAgent.indexOf("Win") ? "win" : "other", this.UA = function() {
                ...
                helper: function(t) {
                    ...
                    return o.trigger("dragstart", {
                        target: r[0],
                        originalEvent: t
                    }), n = r.is("." + o.res("class", "cwdfile")) ? o.selected() : [o.navId2Hash(r.attr("id"))], a.append(s(y[n[0]].mime)).data("files", n).data("locked", !1), (i = n.length) > 1 && a.append(s(y[n[i - 1]].mime) + '<span class="elfinder-drag-num">' + i + "</span>"), a
                }
            }, this.droppable = {
                tolerance: "pointer",
                ...
                drop: function(t, n) {
                    var i, r, a, s = e(this),
                        ...
                        d = [],
                        c = "class";
                    for (s.is("." + o.res(c, "cwd")) ? r = g : s.is("." + o.res(c, "cwdfile")) ? r = s.attr("id") : s.is("." + o.res(c, "navdir")) && (r = o.navId2Hash(s.attr("id"))), i = l.length; i--;) a = l[i], a != r && y[a].phash != r && d.push(a);
                ...
                for (var t, n = y[e || g]; n && n.phash;) n = y[n.phash];
                if (n) return n.hash;
                for (; t in y && y.hasOwnProperty(t);)
                    if (n = y[t], !n.phash && "directory" == !n.mime && n.read) return n.hash;
                return ""
            }, this.cwd = function() {
                return y[g] || {}
                ...
                for (var n, i = []; e && (n = y[e]) && n.hash;) i.unshift(t && n.i18 ? n.i18 : n.name), e = n.phash;
                return i
            }, this.path = function(e, t) {
                return y[e] && y[e].path ? y[e].path : this.path2array(e, t).join(v.separator)
            }, this.url = function(t) {
                var n = y[t];
                if (!n || !n.read) return "";
                ...
                return e.map(b, function(t) {
                    return y[t] ? e.extend({}, y[t]) : null
                })
            }, this.fileByName = function(e, t) {
                var n;
                for (n in y)
                    if (y.hasOwnProperty(n) && y[n].phash == t && y[n].name == e) return y[n]
                ...
                if ("-1" == e && (e = 0), e) {
                    ...
                    e = e.replace(/[gmk]$/i, ""), "g" == t ? e = 1024 * e * 1024 * 1024 : "m" == t ? e = 1024 * e * 1024 : "k" == t && (e = 1024 * e)
                }
                return e
                ...
                if (f && s.fail(function(e) {
                    ...
                    for (; r = F.pop();) "pending" == r.state() && (r.quiet = !0, r.abort());
                return delete t.preventFail, i = this.transport.send(t).fail(g).done(y), "open" == d && (F.unshift(i), s.always(function() {
                    var t = e.inArray(i, F); - 1 !== t && F.splice(t, 1)
                })), s
                ...
                b = e.map(t.data.selected || t.data.value || [], function(e) {
                    return y[e] ? e : null
                })
            }).error(function(t) {
                var n = {
                ...
                e.each(t.data.changed || [], function(t, n) {
                    var i = n.hash;
                    (y[i].width && !n.width || y[i].height && !n.height) && (y[i].width = void 0, y[i].height = void 0), y[i] = y[i] ? e.extend(y[i], n) : n
                })
            }).remove(function(t) {
                for (var n = t.data.removed || [], i = n.length, r = function(t) {
                        var n = y[t];
                        n && ("directory" == n.mime && n.dirs && e.each(y, function(e, n) {
                            n.phash == t && r(e)
                        }), delete y[t])
                    }; i--;) r(n[i])
                ...
                minWidth: 300,
                minHeight: 200
            }), this.options.width && (z = this.options.width), this.options.height && (I = parseInt(this.options.height)), o.resize(z, I), e(document).bind("click." + this.namespace, function(n) {
            ...
            uploads: {
                checkFile: function(t, n) {
                    ...
                    if ("data" == t.type) {
                        var i = e.Deferred(),
                            ...
                            d = function(t) {
                                ...
                                t.readEntries(function(e) {
                                    if (e.length) s = s.concat(i(e)), d(t);
                                    else {
                                        var u = s.length - 1,
                                            p = function(e) {
                        ...
                        return c(t.files.items), setTimeout(function y() {
                            l > 0 ? setTimeout(y, 10) : o.length > 0 ? (c([o.shift()], !0), setTimeout(y, 10)) : i.resolve([r, a])
                        }, 10), i.promise()
                    }
                    var u = [],
                        p = [],
                ...
                xhr: function(t, n) {
                    var i, r = n ? n : this,
                        ...
                        u = e.Deferred().fail(function(e) {
                            ...
                            o && clearTimeout(o), l && !t.multiupload && y() && r.notify({
                                type: "upload",
                                cnt: -f,
                                progress: 0,
                                size: 0
                            }), s && clearTimeout(s), x && r.ui.notify.children(".elfinder-notify-chunkmerge").length && r.notify({
                                type: "chunkmerge",
                                cnt: -1
                            })
                        }),
                        p = new FormData,
                        h = t.input ? t.input.files : r.uploads.checkFile(t, r),
                        f = t.checked && d ? h[0].length : h.length,
                        m = 0,
                        g = 0,
                        v = !1,
                        y = function() {
                        ...
                        if (200 != n ? l = n > 500 ? "errResponse" : "errConnect" : (4 != a.readyState && (l = ["errConnect", "errTimeout"]), a.responseText || (l = ["errResponse", "errDataEmpty"])), l) {
                            if (x || c++ > 3) {
                                ...
                                return f._cid ? (p = new FormData, h = [{
                                    _chunkfail: !0
                                }], p.append("chunk", f._chunk), p.append("cid", f._cid), d = !1, void k(h)) : u.reject(l)
                            }
                            return g = 0, a.open("POST", r.uploadURL, !0), void a.send(p)
                        }
                        if (m = g, y() && (o = m - i) && r.notify({
                                type: "upload",
                                cnt: 0,
                                progress: o,
                                size: 0
                            }), e = r.parseUploadData(a.responseText), e._chunkmerged) {
                            p = new FormData;
                            var v = [{
                                _chunkmerged: e._chunkmerged,
                                _name: e._name
                            }];
                            ...
                            }, r.options.notifyDelay), void(d ? k(v, h[1]) : k(v))
                        }
                        e._multiupload = t.multiupload ? !0 : !1, e.error ? u.reject(e.error) : u.resolve(e)
                    }, !1), a.upload.addEventListener("loadstart", function(e) {
                        !x && e.lengthComputable && (m = e.loaded, c && (m = 0), g = e.total, m || (m = parseInt(.05 * g)), y() && (r.notify({
                            type: "upload",
                            cnt: 0,
                            progress: m - i,
                            size: t.multiupload ? 0 : g
                        }), i = m))
                    }, !1), a.upload.addEventListener("progress", function(e) {
                        var n;
                        e.lengthComputable && !x && (m = e.loaded, !t.checked && m > 0 && !o && (o = b()), g || (c && (m = 0), g = e.total, m || (m = parseInt(.05 * g))), n = m - i, y() && n / e.total >= .05 && (r.notify({
                            type: "upload",
                            cnt: 0,
                            progress: n,
                            size: 0
                    ...
                    var k = function(i, s) {
                        ...
                        if (!l && (d || "files" == t.type)) {
                            ...
                            for (var z = 0; z < i.length; z++)
                                if (c && i[z].size >= c) r.error(r.i18n("errUploadFile", i[z].name) + " " + r.i18n("errUploadFileSize")), f--, x--;
                                else if (n.uplMaxSize && i[z].size >= n.uplMaxSize) {
                                var I = i[z].size,
                                    P = 0,
                                    M = T,
                                    A = -1,
                                ...
                                for (k += I, C[F] = 0; I > P;) {
                                    var O;
                                    if ("slice" in D) O = D.slice(P, M);
                                    else if ("mozSlice" in D) O = D.mozSlice(P, M);
                                    else {
                                        if (!("webkitSlice" in D)) {
                                            O = null;
                                            break
                        ...
                        return l || n.UA.Safari && t.files || (o = b()), l = !0, i.length || u.reject(["errUploadNoFiles"]), a.open("POST", r.uploadURL, !0), n.customHeaders && e.each(n.customHeaders, function(e) {
                    ...
                    return d ? l ? k(h[0], h[1]) : (s = setTimeout(function() {
                        ...
                        s && clearTimeout(s), r.notify({
                            type: "readdir",
                            cnt: -1
                        }), f = e[0].length, f ? k(e[0], e[1]) : u.reject(["errUploadNoFiles"])
                    }).fail(function() {
            ...
            notify: function(t) {
                var n, i, r, a = t.type,
                    o = this.i18n(this.messages["ntf" + a] ? "ntf" + a : "ntfsmth"),
                    s = this.ui.notify,
                    ...
                    c = t.cnt,
                    u = "undefined" != typeof t.size ? parseInt(t.size) : null,
                    p = "undefined" != typeof t.progress && t.progress >= 0 ? t.progress : null;
                return a ? (l.length || (l = e(d.replace(/\{type\}/g, a).replace(/\{msg\}/g, o)).appendTo(s).data("cnt", 0), null != p && l.data({
                    progress: 0,
                    total: 0
                })), n = c + parseInt(l.data("cnt")), n > 0 ? (!t.hideCnt && l.children(".elfinder-notify-cnt").text("(" + n + ")"), s.is(":hidden") && s.elfinderdialog("open"), l.data("cnt", n), null != p && (i = l.data("total")) >= 0 && (r = l.data("progress")) >= 0 && (i += null != u ? u : c, r += p, null == u && 0 > c && (r += 100 * c), l.data({
                    progress: r,
                    total: i
                }), null != u && (r *= 100, i = Math.max(1, i)), p = parseInt(r / i), l.find(".elfinder-notify-progress").animate({
                    width: (100 > p ? p : 100) + "%"
            ...
            formatDate: function(e, t) {
                var n, i, r, a, o, s, l, d, c, u, p, h = this,
                    t = t || e.ts,
                    f = h.i18;
        ...
        }, elFinder.prototype.version = "2.1 (Nightly: da8969b)", e.fn.elfinder = function(e) {
            ...
            lang: "en",
            cssClass: "",
            commands: ["open", "reload", "home", "up", "back", "forward", "getfile", "quicklook", "download", "rm", "duplicate", "rename", "mkdir", "mkfile", "upload", "copy", "cut", "paste", "edit", "extract", "archive", "search", "info", "view", "help", "resize", "sort", "netmount", "netunmount"],
            commandsOptions: {
                getfile: {
                    onlyURL: !1,
                    multiple: !1,
                ...
                var n = e(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu elfinder-contextmenu-" + t.direction).hide().appendTo("body").delegate(".elfinder-contextmenu-item", "mouseenter mouseleave", function() {
                    ...
                    s = function(r, a) {
                        var o = e(window),
                            ...
                            h = t.UA.Touch ? 10 : 0,
                            f = {
                                top: (c > a + h + l ? a + h : a - h - l > 0 ? a - h - l : a + h) + u,
                                left: (d > r + h + s ? r + h : r - h - s) + p,
                        ...
                        e.each(r[i] || [], function(i, r) {
                            ...
                            if (d = t.command(r), d && -1 != d.getstate(a)) {
                                if (d.variants) {
                                    ...
                                    c = o(d.title, d.name, function() {}), u = e('<div class="ui-corner-all elfinder-contextmenu-sub"/>').appendTo(c.append('<span class="elfinder-contextmenu-arrow"/>')), c.addClass("elfinder-contextmenu-group").hover(function() {
                                        u.toggle()
                ...
                var i = "list" == t.viewType,
                    ...
                    P = function(t, n) {
                        ...
                        if (g.length)
                            ...
                            l.is("." + p) && (l = o(l, "prev")), l.length || (d = $.find("[id]:not(." + p + "):last"), d.position().top > c && (l = d))
                        } else l = s;
                        else l = $.find("[id]:not(." + p + "):not(.elfinder-cwd-parent):" + (m ? "last" : "first"));
                    ...
                    D = function() {
                        var n = t.cwd().hash;
                        $.find("[id]:not(." + u + "):not(.elfinder-cwd-parent)").trigger(r), M = e.map(t.files(), function(e) {
                            return e.phash == n ? e.hash : null
                        }), S()
                    },
                    O = function() {
                        M = [], $.find("[id]." + u).trigger(a), S()
                    },
                    S = function() {
                        t.trigger("select", {
                            selected: M
                    ...
                    j = function(e) {
                        for (var t = U.length; t--;)
                            if (U[t].hash == e) return t;
                        return -1
                    },
                    R = "scroll." + t.namespace,
                    q = function() {
                        var n, a = [],
                            o = !1,
                            s = [],
                            ...
                            d = $.find("[id]:last"),
                            c = !d.length,
                            p = i ? $.children("table").children("tbody") : $;
                        if (!U.length) return G.unbind(R);
                        for (;
                            (!d.length || d.position().top <= G.height() + G.scrollTop() + t.options.showThreshold) && (n = U.splice(0, t.options.showFiles)).length;) a = e.map(n, function(e) {
                            return e.hash && e.name ? ("directory" == e.mime && (o = !0), e.tmb && (1 === e.tmb ? s.push(e.hash) : l[e.hash] = e.tmb), z(e)) : null
                        }), p.append(a.join("")), d = $.find("[id]:last"), c && $.scrollTop(0);
                        _(l), s.length && N(s), o && L(), M.length && p.find("[id]:not(." + u + "):not(.elfinder-cwd-parent)").each(function() {
                            var t = this.id; - 1 !== e.inArray(t, M) && e(this).trigger(r)
                        })
                    },
                    H = e.extend({}, t.droppable, {
                        over: function(n, i) {
                            var r = t.cwd().hash;
                            e.each(i.helper.data("files"), function(e, n) {
                                return t.file(n).phash == r ? ($.removeClass(g), !1) : void 0
                            })
                        }
                    }),
                    L = function() {
                        setTimeout(function() {
                            $.find(".directory:not(." + f + ",.elfinder-na,.elfinder-ro)").droppable(t.droppable)
                        }, 20)
                    },
                    _ = function(n) {
                    ...
                    N = function(e) {
                        ...
                        return t.oldAPI ? void t.request({
                            ...
                            _(e.images || []) && e.tmb && N()
                        }) : (n = n = e.splice(0, y), void(n.length && t.request({
                            data: {
                                cmd: "tmb",
                                targets: n
                            },
                    ...
                    W = function(e) {
                        for (var n, r, a, o, s = i ? $.find("tbody") : $, l = e.length, d = [], c = {}, u = !1, p = function(e) {
                                for (var n, i = $.find("[id]:first"); i.length;) {
                                ...
                                var n, i = U.length;
                                for (n = 0; i > n; n++)
                                    if (t.compare(e, U[n]) < 0) return n;
                                return i || -1
                            }; l--;) n = e[l], r = n.hash, $.find("#" + r).length || ((a = p(n)) && a.length ? a.before(z(n)) : (o = h(n)) >= 0 ? U.splice(o, 0, n) : s.append(z(n)), $.find("#" + r).length && ("directory" == n.mime ? u = !0 : n.tmb && (1 === n.tmb ? d.push(r) : c[r] = n.tmb)));
                        _(c), d.length && N(d), u && L()
                    },
                    V = function(e) {
                        for (var n, i, r, a = e.length; a--;)
                            if (n = e[a], (i = $.find("#" + n)).length) try {
                                i.detach()
                            } catch (o) {
                                t.debug("error", o)
                    ...
                    K = function(r, a) {
                        ...
                        O();
                        try {
                            $.children("table," + c).remove()
                        } catch (s) {
                            $.html("")
                        }
                        if ($.removeClass("elfinder-cwd-view-icons elfinder-cwd-view-list").addClass("elfinder-cwd-view-" + (i ? "list" : "icons")), G[i ? "addClass" : "removeClass"]("elfinder-cwd-wrapper-list"), i && $.html('<table><thead><tr class="ui-state-default"><td >' + B.name + "</td><td>" + B.perm + "</td><td>" + B.mod + "</td><td>" + B.size + "</td><td>" + B.kind + "</td></tr></thead><tbody/></table>"), U = e.map(r, function(e) {
                                return a || e.phash == o ? e : null
                            }), U = t.sortFiles(U), G.bind(R, q).trigger(R), o = t.cwd().phash, n.oldSchool && o && !b) {
                            ...
                            l = e(z(l)).addClass("elfinder-cwd-parent").bind("mousedown click mouseup touchstart touchmove touchend dblclick mouseenter", function(e) {
                                ...
                                t.exec("open", this.id)
                            }), (i ? $.find("tbody") : $).prepend(l)
                        }
                    },
                    $ = e(this).addClass("ui-helper-clearfix elfinder-cwd").attr("unselectable", "on").delegate(c, "click." + t.namespace, function(n) {
                        var i, o = this.id ? e(this) : e(this).parents("[id]:first"),
                            s = o.prevAll("." + u + ":first"),
                            l = o.nextAll("." + u + ":first"),
                            d = s.length,
                            c = l.length;
                        if ($.data("longtap")) return void n.stopPropagation();
                        if (n.stopImmediatePropagation(), n.shiftKey && (d || c)) i = d ? o.prevUntil("#" + s.attr("id")) : o.nextUntil("#" + l.attr("id")), i.add(o).trigger(r);
                        else if (n.ctrlKey || n.metaKey) o.trigger(o.is("." + u) ? a : r);
                        else {
                            if (o.data("touching") && o.is("." + u)) return o.data("touching", null), t.dblclick({
                                file: this.id
                            }), void O();
                            O(), o.trigger(r)
                        }
                        ...
                        var i = this.id ? e(this) : e(this).parents("[id]:first"),
                            o = i.prevAll("." + u + ":first").length + i.nextAll("." + u + ":first").length;
                        $.data("longtap", null), i.data("touching", !0), i.data("tmlongtap", setTimeout(function() {
                            $.data("longtap", !0), i.is("." + u) && o > 0 ? (i.trigger(a), S()) : (i.trigger(r), S(), i.trigger(t.trigger("contextmenu", {
                                type: "files",
                                targets: t.selected(),
                        ...
                        var t = e(this).removeClass(u).addClass(p),
                        ...
                        i.length && (n.stopPropagation(), n.preventDefault(), i.is("." + p) || i.data("touching") || (i.is("." + u) || (O(), i.trigger(r), S()), t.trigger("contextmenu", {
                            type: "files",
                            targets: t.selected(),
                            x: n.clientX,
                            y: n.clientY
                        ...
                        return $.data("longtap") ? void e.stopPropagation() : void(!e.shiftKey && !e.ctrlKey && !e.metaKey && O())
                    }).selectable({
                        filter: c,
                        stop: S,
                        delay: 250,
                        ...
                        var r = i ? $.find("tbody") : $,
                            ...
                            n = e(z(n)).addClass(v);
                        O(), a.length ? a.after(n) : r.prepend(n), $.scrollTop(0)
                    ...
                    G = e('<div class="elfinder-cwd-wrapper"/>').bind("contextmenu", function(e) {
                        ...
                        var i = e(this);
                        $.data("longtap", null), i.data("touching", !0), i.data("tmlongtap", setTimeout(function() {
                            $.data("longtap", !0), t.trigger("contextmenu", {
                                type: "cwd",
                                targets: [t.cwd().hash],
                                x: n.originalEvent.touches[0].clientX,
                                y: n.originalEvent.touches[0].clientY
                    ...
                    X = e(this).parent().resize(J),
                    Y = X.children(".elfinder-workzone").append(G.append(this));
                e("body").on("touchstart touchmove touchend", function() {}), t.dragUpload && (G[0].addEventListener("dragenter", function(e) {
                    e.preventDefault(), e.stopPropagation(), G.addClass(g)
                }, !1), G[0].addEventListener("dragleave", function(e) {
                    e.preventDefault(), e.stopPropagation(), e.target == $[0] && G.removeClass(g)
                }, !1), G[0].addEventListener("dragover", function(e) {
                    e.preventDefault(), e.stopPropagation()
                }, !1), G[0].addEventListener("drop", function(e) {
                    G.removeClass(g), t.exec("upload", {
                        dropEvt: e
                    })
                }, !1)), t.bind("open", function(e) {
                    K(e.data.files)
                }).bind("search", function(e) {
                    w = e.data.files, K(w, !0)
                    ...
                    r != i && (i = r, K(t.files()), e.each(n, function(e, t) {
                        A(t)
                    }), S()), J()
                }).add(function(n) {
                    var i = t.cwd().hash,
                        r = b ? e.map(n.data.added || [], function(e) {
                            return -1 === e.name.indexOf(b) ? null : e
                    ...
                    var i = t.cwd().hash,
                        r = t.selected();
                    b ? e.each(n.data.changed || [], function(t, n) {
                        V([n.hash]), -1 !== n.name.indexOf(b) && (W([n]), -1 !== e.inArray(n.hash, r) && A(n.hash))
                    ...
                    $.css("height", "auto"), $.outerHeight(!0) < G.height() && $.height(G.height() - ($.outerHeight(!0) - $.height()) - 2)
                }).dragstart(function(t) {
                    var n = e(t.data.target),
                        i = t.data.originalEvent;
                    n.is(c) && (n.is("." + u) || (!(i.ctrlKey || i.metaKey || i.shiftKey) && O(), n.trigger(r), S()), $.droppable("disable")), $.selectable("disable").removeClass(p), I = !0
                }).dragstop(function() {
                    $.selectable("enable").droppable("enable"), I = !1
                }).bind("lockfiles unlockfiles", function(e) {
                    for (var t = "lockfiles" == e.type ? o : s, n = e.data.files || [], i = n.length; i--;) $.find("#" + n[i]).trigger(t);
                    S()
                    ...
                    callback: function() {
                        O(), E($.find("[id]:first").trigger(r)), S()
                    }
                }).shortcut({
                    pattern: "end",
                    description: "selectlfile",
                    callback: function() {
                        O(), E($.find("[id]:last").trigger(r)), S()
                    }
                })
            }), this
            ...
            return "string" == typeof t && (n = this.closest(".ui-dialog")).length && ("open" == t ? "none" == n.css("display") && n.fadeIn(120, function() {
                ...
                var n = e(this).addClass("ui-dialog-content ui-widget-content"),
                    ...
                    p = e('<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable std42-dialog  ' + a + " " + t.cssClass + '"/>').hide().append(n).appendTo(i).draggable({
                        ...
                        s && r.css({
                            width: s,
                            left: "5px"
                        }), p.trigger("totop"), "function" == typeof t.open && e.proxy(t.open, n[0])(), p.is("." + o) || i.find("." + a + ":visible").not("." + o).each(function() {
                            var t = e(this),
                                n = parseInt(t.css("top")),
                                i = parseInt(t.css("left")),
                                r = parseInt(p.css("top")),
                                a = parseInt(p.css("left"));
                            t[0] == p[0] || n != r && i != a || p.css({
                                top: n + (s ? 15 : 10) + "px",
                                left: (s ? 5 : i + 10) + "px"
                            })
                        })
                ...
                t.position || (t.position = {
                    top: Math.max(0, parseInt((i.height() - p.outerHeight()) / 2 - 42)) + "px",
                    left: Math.max(0, parseInt((i.width() - p.outerWidth()) / 2)) + "px"
                }), p.css(t.position), t.closeOnEscape && e(document).bind("keyup." + l, function(t) {
                    ...
                    c.append(r)
                }), c.children().length && p.append(u), t.resizable && e.fn.resizable && p.resizable({
                    minWidth: t.minWidth,
                    ...
                    if (i = r.resizable({
                        ...
                        var d = function() {
                            i.data("closed") ? (i.data("closed", !1).css({
                                ...
                                width: i.data("width")
                            }).trigger("resize")) : (i.data("closed", !0).css({
                        ...
                        i.data({
                            ...
                            r.width(i.data("defWidth") > e ? e : i.data("defWidth")), i.data("width", r.width())
                        }))
                    }
                    t.one("open", function() {
                        setTimeout(function() {
            ...
            return this.each(function() {
                var i = [],
                    ...
                    g = function(n) {
                        ...
                        }), i.push(n.hash), !r.parent().length && w.append(r), b.addClass(o), r.draggable({
                            appendTo: "body",
                            revert: !1,
                            helper: function() {
                                var n = e(this);
                    ...
                    v = function(t) {
                        var n = e.inArray(t, i); - 1 !== n && (i.splice(n, 1), w.find("#" + h(t)).parent().remove(), !w.children().length && b.removeClass(o + " " + s))
                    },
                    y = m({
                    ...
                    b = y.children("." + a).addClass(l).click(function() {
                        b.is("." + o) && (x.toggleClass(s), w.slideToggle(), t.storage("placesState", x.is("." + s) ? 1 : 0))
                    }),
                    w = y.children("." + t.res(r, "navsubtree")),
                    x = e(this).addClass(t.res(r, "tree") + " elfinder-places ui-corner-all").hide().append(y).appendTo(t.getUI("navbar")).delegate("." + a, "mouseenter mouseleave", function() {
                        e(this).toggleClass("ui-state-hover")
                ...
                t.one("load", function() {
                    t.oldAPI || (x.show().parent().show(), i = e.map(t.storage("places").split(","), function(e) {
                        ...
                        }), f(), t.storage("placesState") > 0 && b.click()
                    }).always(function() {
                        u.remove()
                    })), t.remove(function(t) {
            ...
            return this.each(function() {
                var n = t.fm,
                    ...
                    d = l + "-asc",
                    c = l + "-desc",
                    u = e(this).addClass("ui-state-default elfinder-button elfinder-menubutton elfiner-button-" + i).attr("title", t.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + i + '"/>').hover(function() {
            ...
            return this.not("." + i).each(function() {
                var r = "class",
                    ...
                    x = e.extend(!0, {}, t.droppable, {
                        over: function(t) {
                            var n = e(this),
                                i = m + " " + f;
                            b(t.clientX) ? (n.addClass(i), n.is("." + d + ":not(." + c + ")") && setTimeout(function() {
                    ...
                    C = t.res("tpl", "navdir"),
                    F = t.res("tpl", "perms"),
                    T = (t.res("tpl", "lock"), t.res("tpl", "symlink")),
                    z = {
                        id: function(e) {
                    ...
                    S = function() {
                        U.find("." + l + ":not(." + y + ",.elfinder-ro,.elfinder-na)").droppable(x)
                    },
                    E = function(n, i) {
                    ...
                    U = e(this).addClass(i).delegate("." + l, "mouseenter mouseleave", function(n) {
                        ...
                        var i = e(this),
                            r = t.navId2Hash(i.attr("id")),
                            a = t.file(r);
                        return i.data("longtap") ? void n.stopPropagation() : (t.trigger("searchend"), void(r == t.cwd().hash || i.is("." + g) ? i.is("." + d) && i.children("." + p).click() : t.exec("open", a.thash || r)))
                        ...
                        var i = e(this),
                            r = i.parent("." + l),
                            a = r.next("." + s);
                        n.stopPropagation(), r.is("." + u) ? (r.toggleClass(c), a.slideToggle()) : (k.insertBefore(i), r.removeClass(d), t.request({
                            cmd: "tree",
                ...
                t.open(function(e) {
                    ...
                    for (var i, r, a, o, d, p, h, f, m, g = P(n.data.changed), v = g.length; v--;)
                    ...
                    e.each(a, function(e, n) {
                        ...
                        a.length && (a.is("." + v) && a.draggable(r), a.is("." + y) && a.droppable(h), a[i ? "addClass" : "removeClass"](g))
                    })
                })
            }), this
            ...
            return this.each(function() {
                var n = e(this).elfinderbutton(t).unbind("click"),
                    i = e("<form/>").appendTo(n),
                    r = e('<input type="file" multiple="true" title="' + t.fm.i18n("selectForUpload") + '"/>').change(function() {
                        var n = e(this);
                        n.val() && (t.exec({
                            input: n.remove()[0]
            ...
            var t, n = this.fm,
                i = this,
                r = '<div class="elfinder-help-link"> <a href="{url}" target="_blank">{link}</a></div>',
                a = '<div class="elfinder-help-team"><div>{author}</div>{work}</div>',
                o = /\{url\}/,
                s = /\{link\}/,
                l = /\{author\}/,
                d = /\{work\}/,
                c = "replace",
                u = "ui-priority-primary",
                p = "ui-priority-secondary",
                h = "elfinder-help-license",
                f = '<li class="ui-state-default ui-corner-top"><a href="#{id}">{title}</a></li>',
                m = ['<div class="ui-tabs ui-widget ui-widget-content ui-corner-all elfinder-help">', '<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">'],
                g = '<div class="elfinder-help-shortcut"><div class="elfinder-help-shortcut-pattern">{pattern}</div> {descrip}</div>',
                v = '<div class="elfinder-help-separator"/>',
                y = function() {
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [{
                ...
                }), m.push("</ul>"), -1 !== e.inArray("about", r) && y(), -1 !== e.inArray("shortcuts", r) && b(), -1 !== e.inArray("help", r) && w(), m.push("</div>"), t = e(m.join("")), n.one("load", function() {
            ...
            this.tpl = {
                ...
                if (1 == f) {
                    if (s = r[0], g = g.replace("{class}", c.mime2class(s.mime)), l = p.itemTitle.replace("{name}", c.escape(s.i18 || s.name)).replace("{kind}", c.mime2kind(s)), s.tmb && (o = c.option("tmbUrl") + s.tmb), s.read ? "directory" != s.mime || s.alias ? a = c.formatSize(s.size) : (a = p.spinner.replace("{text}", i.calc).replace("{name}", "size"), w.push(s.hash)) : a = i.unknown, m.push(h.replace(v, i.size).replace(y, a)), s.alias && m.push(h.replace(v, i.aliasfor).replace(y, s.alias)), m.push(h.replace(v, i.path).replace(y, c.escape(c.path(s.hash, !0)))), s.read) {
                        var F;
                        if ("1" == s.url) m.push(h.replace(v, i.link).replace(y, p.spinner.replace("{text}", i.modify).replace("{name}", "url"))), c.request({
                            data: {
                                cmd: "url",
                                target: s.hash
                            },
                            ...
                            m.push(h.replace(v, i.link).replace(y, '<a href="' + F + '" target="_blank">' + s.name + "</a>"))
                        }
                    }
                    s.dim ? m.push(h.replace(v, i.dim).replace(y, s.dim)) : -1 !== s.mime.indexOf("image") && (s.width && s.height ? m.push(h.replace(v, i.dim).replace(y, s.width + "x" + s.height)) : (m.push(h.replace(v, i.dim).replace(y, p.spinner.replace("{text}", i.calc).replace("{name}", "dim"))), c.request({
                        data: {
                            cmd: "dim",
                            target: s.hash
                        },
                    ...
                    }))), m.push(h.replace(v, i.modify).replace(y, c.formatDate(s))), m.push(h.replace(v, i.perms).replace(y, c.formatPermissions(s))), m.push(h.replace(v, i.locked).replace(y, s.locked ? i.yes : i.no))
                ...
                }).length, d ? (m.push(h.replace(v, i.kind).replace(y, d == f ? i.folders : i.folders + " " + d + ", " + i.files + " " + (f - d))), m.push(h.replace(v, i.size).replace(y, p.spinner.replace("{text}", i.calc).replace("{name}", "size"))), w = e.map(r, function(e) {
                    return e.hash
                })) : (a = 0, e.each(r, function(e, t) {
                    var n = parseInt(t.size);
                    n >= 0 && a >= 0 ? a += n : a = "unknown"
                }), m.push(h.replace(v, i.kind).replace(y, i.files)), m.push(h.replace(v, i.size).replace(y, c.formatSize(a))));
                g = g.replace("{title}", l).replace("{content}", m.join("")), C = c.dialog(g, b), C.attr("id", k), o && e("<img/>").load(function() {
                ...
                var n = t.fm,
                    ...
                    a = function() {
                        var a = {
                            ...
                            s = e('<table class="elfinder-info-tb elfinder-netmount-tb"/>'),
                            l = e("<div/>");
                        return s.append(e("<tr/>").append(e("<td>" + n.i18n("protocol") + "</td>")).append(e("<td/>").append(a.protocol))), e.each(t.drivers, function(t, i) {
                            ...
                            return e.each(s.find("input.elfinder-netmount-inputs-" + n), function(t, n) {
                                var i;
                                i = e.trim("function" == typeof n.val ? n.val() : n.value), i && (r[n.name] = i)
                            }), r.host ? (t.fm.request({
                                data: r,
                                notify: {
                                    type: "netmount",
                                ...
                                i.reject(e)
                            }), void t.dialog.elfinderdialog("close")) : t.fm.trigger("error", {
            ...
            this.alwaysEnabled = !0, this._handlers = {
                ...
                if (1 == h && (n = p[0]) && "directory" == n.mime) return n && !n.read ? u.reject(["errOpen", n.name, "errPerm"]) : c.request({
                    data: {
                        cmd: "open",
                ...
                for (h = p.length; h--;) {
                    ...
                    if (c.UA.Mobile) {
                        ...
                        var g = e.extend({}, c.options.customData, {
                            cmd: "file",
                            target: n.hash
                        });
            ...
            this.updateOnSelect = !1, this.handlers = {
                ...
                return s && t && "directory" == t.mime ? t.write ? (n = a.parents(t.hash), e.each(o, function(r, s) {
                    ...
                    }).length ? !p.reject(["errReplByChild", s.name]) : void(s.phash == t.hash ? u.push(s.hash) : c.push({
                        hash: s.hash,
                        phash: s.phash,
                        name: s.name
                    }))) : !p.reject([d, o[0].name, "errPerm"])
            ...
            var t, n, i, r, a = this,
                ...
                m = function() {
                    var i = e(window),
                        ...
                        a = Math.min(n, e(window).height() - 80);
                    return {
                        opacity: 1,
                        width: r,
                        height: a,
                ...
                w = e('<div class="' + u + " " + u + '-fullscreen"/>').mousedown(function(t) {
                    var n = a.window,
                        r = n.is("." + p),
            ...
            this.resize = "resize." + o.namespace, this.info = e('<div class="elfinder-quicklook-info-wrapper"/>').append(y).append(b), this.preview = e('<div class="elfinder-quicklook-preview ui-helper-clearfix"/>').bind("change", function() {
                a.info.attr("style", "").hide(), y.removeAttr("class").attr("style", ""), b.html("")
                ...
                r ? (!r.read && t.stopImmediatePropagation(), a.window.data("hash", r.hash), a.preview.unbind("changesize").trigger("change").children().remove(), v.html(i.escape(r.name)), b.html(o.replace(/\{value\}/, r.name) + o.replace(/\{value\}/, i.mime2kind(r)) + ("directory" == r.mime ? "" : o.replace(/\{value\}/, i.formatSize(r.size))) + o.replace(/\{value\}/, i.i18n("modify") + ": " + i.formatDate(r))), y.addClass("elfinder-cwd-icon ui-corner-all " + i.mime2class(r.mime)), r.tmb && e("<img/>").hide().appendTo(a.preview).load(function() {
                    y.css("background", 'url("' + n + '") center center no-repeat'), e(this).remove()
                ...
                var n, i, r = this.fm,
                    ...
                    s = function(t, n) {
                        var i = e('<div class="elfinder-dialog-resize"/>'),
                            ...
                            u = e('<div class="elfinder-resize-spinner">' + r.i18n("ntfloadimg") + "</div>"),
                            ...
                            F = e('<div class="elfinder-resize-type"/>').append('<input type="radio" name="type" id="' + n + '-resize" onclick="val=\'resize\';" value="resize" checked="checked" /><label for="' + n + '-resize">' + r.i18n("resize") + "</label>").append('<input type="radio" name="type" id="' + n + '-crop" onclick="val=\'crop\';" value="crop" /><label for="' + n + '-crop">' + r.i18n("crop") + "</label>").append('<input type="radio" name="type" id="' + n + '-rotate" onclick="val=\'rotate\';" value="rotate" /><label for="' + n + '-rotate">' + r.i18n("rotate") + "</label>"),
                            T = e("input", F).click(function() {
                                X(), et(!0), tt(!0), nt(!0), "resize" == val ? (f.show(), b.hide(), m.hide(), et()) : "crop" == val ? (b.hide(), f.hide(), m.show(), tt()) : "rotate" == val && (f.hide(), m.hide(), b.show(), nt())
                            }),
                            ...
                            P = e(a).change(function() {
                                var e = parseInt(P.val()),
                                    t = parseInt(H ? Math.round(e * U) : I.val());
                            ...
                            Z = {
                                update: function() {
                                    D.val(Math.round((h.data("w") || h.width()) / j)), O.val(Math.round((h.data("h") || h.height()) / j)), M.val(Math.round(((h.data("x") || h.offset().left) - $.offset().left) / j)), A.val(Math.round(((h.data("y") || h.offset().top) - $.offset().top) / j))
                                },
                                updateView: function() {
                                    var e = parseInt(M.val()) * j + $.offset().left,
                                        t = parseInt(A.val()) * j + $.offset().top,
                                        n = D.val() * j,
                                        i = O.val() * j;
                                    h.data({
                                        x: e,
                                        ...
                                        w: n,
                                        h: i
                                    }), h.width(Math.round(n)), h.height(Math.round(i)), G.width(h.width()), G.height(h.height()), h.offset({
                                        left: Math.round(e),
                                        top: Math.round(t)
                                    })
                                },
                                resize_update: function() {
                                    h.data({
                                        w: null,
                                        h: null
                                    }), Z.update(), G.width(h.width()), G.height(h.height())
                                },
                            ...
                            Q = {
                                ...
                                imageBeingRotated: !1,
                                update: function(e, t) {
                                    "undefined" == typeof e && (V = e = parseInt(S.val())), "undefined" == typeof t && (t = !0), !t || r.UA.Opera || r.UA.ltIE8 ? J.rotate(e) : J.animate({
                                        rotate: e + "deg"
                            ...
                            et = function(t) {
                                e.fn.resizable && (t ? (p.filter(":ui-resizable").resizable("destroy"), p.hide()) : (p.show(), p.resizable({
                                    alsoResize: B,
                                    aspectRatio: H,
                                    resize: Y.update,
                                    stop: Y.fixHeight
                            ...
                            tt = function(t) {
                                e.fn.draggable && e.fn.resizable && (t ? (h.filter(":ui-resizable").resizable("destroy"), h.filter(":ui-draggable").draggable("destroy"), K.hide()) : ($.width(B.width()).height(B.height()), G.width(B.width()).height(B.height()), h.width($.width()).height($.height()).offset($.offset()).resizable({
                                    containment: K,
                            ...
                            it = function() {
                                var e, n, a, s, l, d = val;
                                if ("resize" == d) e = parseInt(I.val()) || 0, n = parseInt(P.val()) || 0;
                                else if ("crop" == d) e = parseInt(D.val()) || 0, n = parseInt(O.val()) || 0, a = parseInt(M.val()) || 0, s = parseInt(A.val()) || 0;
                                else if ("rotate" == d) {
                                    if (e = R, n = q, l = parseInt(S.val()) || 0, 0 > l || l > 360) return r.error("Invalid rotate degree");
                                    if (0 == l || 360 == l) return r.error("Image dose not rotated")
                                }
                                if ("rotate" != d) {
                                    if (0 >= e || 0 >= n) return r.error("Invalid image size");
                                    if (e == R && n == q) return r.error("Image size not changed")
                                }
                                val = "resize", i.elfinderdialog("close"), r.request({
                                    data: {
                                        cmd: "resize",
                                        target: t.hash,
                                        width: e,
                        ...
                        J.mousedown(Q.start), e(document).mouseup(Q.stop), f.append(e(s).append(e(l).text(r.i18n("width"))).append(I).append(C)).append(e(s).append(e(l).text(r.i18n("height"))).append(P)).append(e(s).append(e("<label/>").text(r.i18n("aspectRatio")).prepend(z))).append(e(s).append(r.i18n("scale") + " ").append(k)), m.append(e(s).append(e(l).text("X")).append(M)).append(e(s).append(e(l).text("Y")).append(A)).append(e(s).append(e(l).text(r.i18n("width"))).append(D)).append(e(s).append(e(l).text(r.i18n("height"))).append(O)), b.append(e(s).append(e(l).text(r.i18n("rotate"))).append(e('<div style="float:left; width: 130px;">').append(e('<div style="float:left;">').append(S).append(e("<span/>").text(r.i18n("degree")))).append(e(g).append(w).append(e(y)).append(x))).append(E)), i.append(F), d.append(e(s)).append(f).append(m.hide()).append(b.hide()).find("input,select").attr("disabled", "disabled"), p.append('<div class="' + at + " " + at + '-top"/>').append('<div class="' + at + " " + at + '-bottom"/>').append('<div class="' + ot + " " + ot + '-left"/>').append('<div class="' + ot + " " + ot + '-right"/>').append('<div class="' + st + " " + st + '-e"/>').append('<div class="' + st + " " + st + '-se"/>').append('<div class="' + st + " " + st + '-s"/>'), c.append(u).append(p.hide()).append(B.hide()), h.css("position", "absolute").append('<div class="' + at + " " + at + '-top"/>').append('<div class="' + at + " " + at + '-bottom"/>').append('<div class="' + ot + " " + ot + '-left"/>').append('<div class="' + ot + " " + ot + '-right"/>').append('<div class="' + st + " " + st + '-n"/>').append('<div class="' + st + " " + st + '-e"/>').append('<div class="' + st + " " + st + '-s"/>').append('<div class="' + st + " " + st + '-w"/>').append('<div class="' + st + " " + st + '-ne"/>').append('<div class="' + st + " " + st + '-se"/>').append('<div class="' + st + " " + st + '-sw"/>').append('<div class="' + st + " " + st + '-nw"/>'), c.append(K.css("position", "absolute").hide().append($).append(h.append(G))), c.append(J.hide()), c.css("overflow", "hidden"), i.append(c).append(d), rt[r.i18n("btnApply")] = it, rt[r.i18n("btnCancel")] = function() {
                        ...
                        }).attr("id", n), r.UA.ltIE8 && e(".elfinder-dialog").css("filter", ""), C.css("left", I.position().left + I.width() + 12), G.css({
                            opacity: .2,
                            ...
                            opacity: .5,
                            "border-color": "#000"
                        }), J.css("cursor", "pointer"), F.buttonset(), L = c.width() - (p.outerWidth() - p.width()), _ = c.height() - (p.outerHeight() - p.height()), B.attr("src", lt + (-1 === lt.indexOf("?") ? "?" : "&") + "_=" + Math.random()), $.attr("src", B.attr("src")), J.attr("src", B.attr("src"))
                    };
        ...
        function(e) {
            ...
            if (e.cssHooks.rotate = {
                ...
                var n = function(e) {
                    ...
                    r = function(e, t) {
                        ...
                        var p = parseInt(e.style.width || e.width || 0),
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !1;
            this.shortcuts = [{
                pattern: "ctrl+up"
            }], this.getstate = function() {
            ...
            this.disableOnSearch = !0, this.updateOnSelect = !1, this.shortcuts = [{
                ...
                return i = e.Deferred(), c = function(e) {
                    ...
                    setTimeout(function() {
                        if (r.innerHTML) {
                            var e = r.innerHTML.replace(/<br[^>]*>/gi, " "),
                                t = e.match(/<[^>]+>/) ? "html" : "text";
                            r.innerHTML = "", p({
                                files: [e],
                                type: t
                ...
                }, !1)) : l.prependTo(r).after('<div class="elfinder-upload-dialog-or">' + u.i18n("or") + "</div>")[0], u.dialog(r, {
                    title: this.title,
                    modal: !0,
                    resizable: !1,
                    destroyOnClose: !0
            ...
            this.title = "Add selected to product", this.alwaysEnabled = !0, this.updateOnSelect = !0, this.getstate = function(t) {
                if ("function" == typeof parent.addMultiImage) var t = this.files(t),
                    n = t.length;
                return n && e.map(t, function(e) {
                    return e.phash && e.read && !e.locked ? e : null
                }).length == n ? 0 : -1
                ...
                e.each(this.files(t), function(t, r) {
                    var a = n.option("url"),
                        o = n.url(r.hash),
                        s = o.replace(a, "");
                    s = s.replace(/\\/g, "/"), "function" == typeof parent.addMultiImage ? parent.addMultiImage(s) : i = e.Deferred().fail(function() {
                        n.error("The function is available only on Product layout.")
                    })
                })
            }
...
}(jQuery), elFinder.prototype._options.commands.push("multiupload"), elFinder.prototype._options.contextmenu.files.push("multiupload"), elFinder.prototype.i18.en.messages.cmdmultiupload = "Add selected to product";