<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    ...
    <ul>
      ...
      <li><a href="<?php echo $booking; ?>">Khách hàng đặt vé</a></li>

      <li><a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a></li>

      <li><a href="<?php echo $filter; ?>"><?php echo $text_filter; ?></a></li>

          <li><a href="<?php echo $country; ?>">Tỉnh/thành phố</a></li>

          <li><a href="<?php echo $zone; ?>">Quận/Huyện</a></li>
      ...
      <li><a href="<?php echo $video; ?>">Video</a></li>
  ...
  <li id="design"><a class="parent"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_design; ?></span></a>
    ...
    <ul>
      ...
      <li><a href="<?php echo $slideshow; ?>">Slideshow trình diễn</a></li>
