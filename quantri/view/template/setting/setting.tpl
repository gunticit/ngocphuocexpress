          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                    ...
                    <div class="form-group required">
                      ...
                      <label class="col-sm-2 control-label" for="input-address2-<?php echo $language_id; ?>">Chi nhánh 2</label>

                      <div class="col-sm-10">
                        <textarea name="config_address2[<?php echo $language_id; ?>]" placeholder="Chi nhánh 2" rows="5" id="input-address2-<?php echo $language_id; ?>" class="form-control"><?php echo $config_address2[$language_id]; ?></textarea>
                      </div>

                    </div>

                    <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-gpcn-<?php echo $language_id; ?>">Giấy phép chứng nhận</label>
                      <div class="col-sm-10">
                        <textarea name="config_gpcn[<?php echo $language_id; ?>]" placeholder="Giấy phép chứng nhận" rows="5" id="input-gpcn-<?php echo $language_id; ?>" class="form-control"><?php echo $config_gpcn[$language_id]; ?></textarea>
                      </div>
                    ...
                    <div class="form-group required">
                      ...
                      <label class="col-sm-2 control-label" for="input-hotline-<?php echo $language_id; ?>">Hotline</label>

                      <div class="col-sm-10">

                        <input type="text" name="config_hotline[<?php echo $language_id; ?>]" value="<?php echo $config_hotline[$language_id]; ?>" placeholder="Hotline" id="input-hotline-<?php echo $language_id; ?>" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-2 control-label" for="input-welcome-<?php echo $language_id; ?>"><?php echo $entry_welcome; ?></label>

                      <div class="col-sm-10">

                        <textarea name="config_welcome[<?php echo $language_id; ?>]" placeholder="<?php echo $entry_welcome; ?>" rows="5" id="input-welcome-<?php echo $language_id; ?>" class="form-control"><?php echo $config_welcome[$language_id]; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-2 control-label" for="input-about-us-<?php echo $language_id; ?>"><?php echo $entry_about_us; ?></label>

                      <div class="col-sm-10">

                        <textarea name="config_about_us[<?php echo $language_id; ?>]" placeholder="<?php echo $entry_about_us; ?>" rows="5" id="input-about-us-<?php echo $language_id; ?>" class="form-control"><?php echo $config_about_us[$language_id]; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-2 control-label" for="input-tamnhin-<?php echo $language_id; ?>">Tầm nhìn</label>

                      <div class="col-sm-10">

                        <textarea name="config_tamnhin[<?php echo $language_id; ?>]" placeholder="Tầm nhìn" rows="5" id="input-tamnhin-<?php echo $language_id; ?>" class="form-control"><?php echo $config_tamnhin[$language_id]; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-2 control-label" for="input-sumenh-<?php echo $language_id; ?>">Sứ mệnh</label>

                      <div class="col-sm-10">

                        <textarea name="config_sumenh[<?php echo $language_id; ?>]" placeholder="Sứ mệnh" rows="5" id="input-sumenh-<?php echo $language_id; ?>" class="form-control"><?php echo $config_sumenh[$language_id]; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-2 control-label" for="input-gtcl-<?php echo $language_id; ?>">Giá trị cốt lõi</label>

                      <div class="col-sm-10">

                        <textarea name="config_gtcl[<?php echo $language_id; ?>]" placeholder="Giá trị cốt lõi" rows="5" id="input-gtcl-<?php echo $language_id; ?>" class="form-control"><?php echo $config_gtcl[$language_id]; ?></textarea>
                ...
                <label class="col-sm-2 control-label" for="input-open-<?php echo $language_id; ?>"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open; ?></span></label>

                <div class="col-sm-10">

                  <textarea name="config_open[<?php echo $language_id; ?>]" rows="5" placeholder="<?php echo $entry_open; ?>" id="input-open-<?php echo $language_id; ?>" class="form-control"><?php echo $config_open[$language_id]; ?></textarea>
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-logoft">Logo Footer(Nếu khác logo header)</label>

                <div class="col-sm-10"><a href="" id="thumb-logoft" data-toggle="image" class="img-thumbnail"><img src="<?php echo $logoft; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>

                  <input type="hidden" name="config_logoft" value="<?php echo $config_logoft; ?>" id="input-logoft" />
            ...
            <div class="tab-pane" id="tab-community">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-community-tumblr">Đường dẫn Zalo</label>

                <div class="col-sm-10">

                  <input type="text" name="config_community_tumblr" value="<?php echo $config_community_tumblr; ?>" placeholder="Đường dẫn Zalo" id="input-community-tumblr" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-community-zingme">Đường dẫn skyper</label>

                <div class="col-sm-10">

                  <input type="text" name="config_community_zingme" value="<?php echo $config_community_zingme; ?>" placeholder="Đường dẫn skyper" id="input-community-zingme" class="form-control" />
            ...
            <div class="tab-pane" id="tab-server">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <label class="col-sm-2 control-label"><?php echo $entry_first_time; ?></label>

                  <div class="col-sm-10">

                    <label class="radio-inline">

                      <?php if ($config_first_time) { ?>

                      <input type="radio" name="config_first_time" value="1" checked="checked" />

                      <?php echo $text_yes; ?>

                      <?php } else { ?>

                      <input type="radio" name="config_first_time" value="1" />
                    ...
                    <label class="radio-inline">
                      ...
                      <input type="radio" name="config_first_time" value="0" checked="checked" />

                      <?php echo $text_no; ?>

                      <?php } else { ?>

                      <input type="radio" name="config_first_time" value="0" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="config_license" value="<?php echo $config_license; ?>" placeholder="<?php echo $entry_license; ?>" id="input-license" class="form-control" />
...
$('#input-about-us-<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-welcome-<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-gpcn-<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-tamnhin-<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-sumenh-<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-gtcl-<?php echo $language['language_id']; ?>').summernote({height: 300});
