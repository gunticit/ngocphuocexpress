        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-image">Hình ảnh<br>Lưu ý: Đặt tên thư mục và hình ảnh tiếng việt không dấu, không ký tự đặc biết hay khoảng trắng <br> Kích thước: (500x500)</label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom"><span data-toggle="tooltip" title="Hiển thị dưới footer cột 1">Hiển thị dưới footer cột 1</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom2"><span data-toggle="tooltip" title="Đánh dấu nếu trang Giới thiệu">Trang giới thiệu</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom2) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom3"><span data-toggle="tooltip" title="Trang kỳ nghỉ">Trang kỳ nghỉ</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom3) { ?>
                        <input type="checkbox" name="bottom3" value="1" checked="checked" id="input-bottom3" />
                      <?php } else { ?>
                        <input type="checkbox" name="bottom3" value="1" id="input-bottom3" />
                      <?php } ?>
                    &nbsp; </label>
                  </div>
                </div>
