      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-descript" data-toggle="tab">Mô tả</a></li>
            ...
            <li><a href="#tab-khoihanh" data-toggle="tab">Ngày giờ khởi hành</a></li>
          ...
          <div class="tab-content">
                  ...
                  <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control" />
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-image"><?php echo $entry_image; ?><br>Lưu ý: Đặt tên thư mục và hình ảnh tiếng việt không dấu, không ký tự đặc biết hay khoảng trắng <br> Kích thước: (500x500)</label>
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-sku"><span data-toggle="tooltip" title="Điểm đi">Điểm đi</span></label>

                <div class="col-sm-10">

                  <!-- <input type="text" name="sku" value="<?php echo $sku; ?>" placeholder="Điểm đi" id="input-sku" class="form-control" /> -->

                  <select class="form-control chosen-select" name="sku" data-placeholder="Chọn điểm đi" id="diem-di">
                    ...
                    <?php foreach($countries as $country){ ?> 
                      <optgroup label="<?= $country['name']; ?>">
                        <?php foreach($country['zones'] as $zone){ ?> 
                          <option value="<?= $zone['zone_id']; ?>" <?= ($zone['zone_id'] == $sku)?'selected':'';?> ><?= $zone['name']; ?></option>
                        <?php } ?>
                      </optgroup>
                    <?php } ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-upc"><span data-toggle="tooltip" title="Điểm đến">Điểm đến</span></label>

                <div class="col-sm-10">

                  <!-- <input type="text" name="upc" value="<?php echo $upc; ?>" placeholder="Điểm đến" id="input-upc" class="form-control" /> -->
                  <select class="form-control chosen-select" name="upc" data-placeholder="Chọn điểm đến" id="diem-den">
                    ...
                    <?php foreach($countries as $country){ ?> 
                      <optgroup label="<?= $country['name']; ?>">
                        <?php foreach($country['zones'] as $zone){ ?> 
                          <option value="<?= $zone['zone_id']; ?>" <?= ($zone['zone_id'] == $upc)?'selected':'';?>><?= $zone['name']; ?></option>
                        <?php } ?>
                      </optgroup>
                    <?php } ?>
                  </select>
              ...
              <div class="form-group" style="opacity: 0;height:0;margin:0 !important;padding:0 !important; overflow: hidden !important;">

                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="Xuất bến">Xuất bến</span></label>

                <div class="col-sm-10">

                  <input type="text" name="ean" value="<?php echo $ean; ?>" placeholder="Xuất bến" id="input-ean" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-jan"><span data-toggle="tooltip" title="Loại xe">Loại xe</span></label>

                <div class="col-sm-10">

                  <input type="text" name="jan" value="<?php echo $jan; ?>" placeholder="Loại xe" id="input-jan" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-isbn"><span data-toggle="tooltip" title="Hành trình">Hành trình (tiếng)</span></label>

                <div class="col-sm-10">

                  <input type="text" name="isbn" value="<?php echo $isbn; ?>" placeholder="Hành trình" id="input-isbn" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-qdg"><span data-toggle="tooltip" title="Quảng đường (km)">Quảng đường (km)</span></label>

                <div class="col-sm-10">

                  <input type="number" name="qdg" value="<?php echo $qdg; ?>" placeholder="Quảng đường (km)" id="input-qdg" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-mpn">Hotline Đặt vé 1(nếu có):</label>

                <div class="col-sm-10">

                  <input type="text" name="mpn" value="<?php echo $mpn; ?>" placeholder="Hotline Đặt vé 1" id="input-mpn" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-location">Hotline Đặt vé 2(nếu có):</label>

                <div class="col-sm-10">

                  <input type="text" name="location" value="<?php echo $location; ?>" placeholder="Hotline Đặt vé 2" id="input-location" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-quantity">Số ghế / giường</label>

                <div class="col-sm-10">

                  <input type="number" name="quantity" value="<?php echo $quantity; ?>" placeholder="Số ghế / giường" id="input-quantity" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-minimum"><span data-toggle="tooltip" title="Số lượng đặt tối thiểu">Số lượng đặt tối thiểu</span></label>

                <div class="col-sm-10">

                  <input type="text" name="minimum" value="<?php echo $minimum; ?>" placeholder="Số lượng đặt tối thiểu" id="input-minimum" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-subtract">Tự động trừ ghế/ giường đã đặt</label>
              ...
              <!-- <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-date-available">Ngày khởi hành</label>
              ...
              <div class="tab-pane" id="tab-links">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   ...
                   <div class="scrollbox" style="width: 350px; height: 300px;overflow: auto;">
                  ...
                  <a onclick="$(this).parent().find(':checkbox').attr('checked', true);"><?php echo 'all'; ?></a> / <a onclick="$(this).parent().find(':checkbox').attr('checked', false);"><?php echo 'none'; ?></a>
            ...
            <div class="col-sm-10">
             ...
             <table>
              ...
              <tr>
                ...
                <td style="padding: 0;"><select multiple="multiple" id="product" size="10" style="width:300px; height:300px; "></select></td>
                ...
                <td style="vertical-align: middle;"><input type="button" value="--&gt;" onclick="addRelated();" />
                  ...
                  <td style="padding: 0;"><select multiple="multiple" id="related" size="10" style="width:300px; height:300px; "></select></td>
            ...
            <div class="row">
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="tab-pane" id="tab-special">
                      ...
                      <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="tab-khoihanh">
                            ...
                            <table id="special" class="table table-striped table-bordered table-hover">
                              ...
                              <thead>
                                ...
                                <tr>
                                  ...
                                  <td class="text-left">Ngày xuất hành</td>

                                  <td class="text-right">Giờ xuất hành</td>

                                  <td class="text-right">Giá vé</td>
                              ...
                              <tbody>
                                ...
                                <?php foreach ($product_datehours as $product_datehour) { ?>

                                  <tr id="date-pro-row<?php echo $date_pro_row; ?>">

                                    <td class="text-left" style="width: 30%;">
                                      <div class="input-group date">
                                        <input type="text" name="product_datehour[<?php echo $date_pro_row; ?>][date_product]" value="<?php echo $product_datehour['date_product']; ?>" placeholder="Ngày xuất phát" data-date-format="YYYY-MM-DD" class="form-control" />
                                        <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                        </span>
                                      </div>
                                    ...
                                    <td class="text-left" style="width: 30%;">
                                      <div class="input-group date">
                                        <input type="time" name="product_datehour[<?php echo $date_pro_row; ?>][hour_product]" value="<?php echo $product_datehour['hour_product']; ?>" placeholder="Giờ xuất phát" class="form-control" />
                                      </div>
                                    </td>
                                    <td class="text-right" style="width: 30%;">
                                      <input type="text" name="product_datehour[<?php echo $date_pro_row; ?>][price]" value="<?php echo $product_datehour['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" />
                                    </td>

                                    <td class="text-left">
                                      <button type="button" onclick="$('#date-pro-row<?php echo $date_pro_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                                    </td>
                              ...
                              <tfoot>
                                ...
                                <tr>
                                  ...
                                  <td class="text-left"><button type="button" onclick="addDateHour();" data-toggle="tooltip" title="<?php echo $button_special_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                              ...
                              <thead>
                                ...
                                <tr>
                                  ...
                                  <?php if ($pim_status && !$pim_miu) {?>
                                    ...
                                    <td class="text-left"><?php echo 'Hình ảnh mặc định'; ?></td>
                                ...
                                <tr>
                                  ...
                                  <td class="text-left">
                                    ...
                                    <?php if ($pim_status){?>
                                      ...
                                      <a type="button" data-toggle="manager" title="<?php echo 'Power Image Manager'; ?>" class="btn btn-success"><i class="fa fa-upload"></i> <?php echo 'Power Image Manager'; ?></a>&nbsp;
                        ...
                        <div class="tab-pane" id="tab-descript">

                          <div class="table-responsive">

                            <table id="images-des" class="table table-striped table-bordered table-hover">
                              ...
                              <tbody>
                                ...
                                <?php foreach ($product_desc as $p_desc) { ?>

                                  <tr id="desc-row<?php echo $desc_row; ?>">

                                    <td class="text-left" style="width:80%;">
                                      <input type="text" name="product_desc[<?php echo $desc_row; ?>][title]" value="<?php echo $p_desc['title']; ?>" placeholder="Tiêu đề" class="form-control" />
                                      <textarea name="product_desc[<?= $desc_row; ?>][description]" id="product-desc-<?= $desc_row; ?>" placeholder="Mô tả" style="width:100%;min-height:140px">
                                        <?= trim($p_desc['description']); ?>
                                      </textarea>
                                    </td>
                                    <td class="text-right"><input type="text" name="product_desc[<?php echo $desc_row; ?>][sort_order]" value="<?php echo $p_desc['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                              ...
                              <tfoot>
                                ...
                                <tr>
                                  ...
                                  <td class="text-right">
                                    <button type="button" onclick="addDesc();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button>
              ...
              <script type="text/javascript"><!--
                ...
                <?php foreach ($languages as $language) { ?>
                  ...
                  $('#input-mtangan<?php echo $language['language_id']; ?>').summernote({height: 300});
...
<script type="text/javascript"><!--
  ...
  var date_pro_row = <?php echo $date_pro_row; ?>;

  function addDateHour() {

  html  = '<tr id="special-row' + date_pro_row + '">';

  html += '  <td class="text-left" style="width: 30%;"><div class="input-group date"><input type="text" name="product_datehour[' + date_pro_row + '][date_product]" value="" placeholder="Ngày xuất phát" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';

  html += '  <td class="text-left" style="width: 30%;"><div class="input-group date"><input type="time" name="product_datehour[' + date_pro_row + '][hour_product]" value="" placeholder="Giờ xuất phát" class="form-control" /></div></td>';

  html += '  <td class="text-right"><input type="text" name="product_datehour[' + date_pro_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>';

  html += '  <td class="text-left"><button type="button" onclick="$(\'#special-row' + date_pro_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
...
<script type="text/javascript"><!--
  ...
  function addDesc() {
   ...
   html += '<td class="text-left" style="width:80%;"><input type="text" name="product_desc['+ desc_row +'][title]" value="" placeholder="Tiêu đề" class="form-control" /><textarea name="product_desc['+ desc_row +'][description]" id="product-desc-'+ desc_row +'" placeholder="Mô tả" style="width:100%;min-height:140px"></textarea></td>';
   html += '<td class="text-right"><input type="text" name="product_desc['+ desc_row +'][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
  ...
  <script type="text/javascript"><!--
   ...
   function getProducts() {
    ...
    $.ajax({
     ...
     url: 'index.php?route=catalog/product/category&token=<?php echo $token; ?>&category_id=' + $('#category').val(),
