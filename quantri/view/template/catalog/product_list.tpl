            ...
            <table class="table table-bordered table-hover">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Tên hành trình</a>

                    <?php } else { ?>

                    <a href="<?php echo $sort_name; ?>">Tên hành trình</a>

                    <?php } ?></td>

                  <td class="text-center"><?php if ($sort == 'p.model') { ?>

                    <a href="<?php echo $sort_model; ?>" class="<?php echo strtolower($order); ?>">Nhóm</a>

                    <?php } else { ?>

                    <a href="<?php echo $sort_model; ?>">Nhóm</a>

                    <?php } ?></td>

                  <td class="text-center"><?php if ($sort == 'p.price') { ?>

                    <a href="<?php echo $sort_price; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_price; ?> vé</a>

                    <?php } else { ?>

                    <a href="<?php echo $sort_price; ?>"><?php echo $column_price; ?> vé</a>

                    <?php } ?></td>

                  <td class="text-center"><?php if ($sort == 'p.quantity') { ?>

                    <a href="<?php echo $sort_quantity; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_quantity; ?> chỗ ngồi</a>

                    <?php } else { ?>

                    <a href="<?php echo $sort_quantity; ?>"><?php echo $column_quantity; ?> chỗ ngồi</a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php if ($product['special']) { ?>
