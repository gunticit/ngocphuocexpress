  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $language_editor; ?>" data-toggle="tooltip" title="<?php echo $button_language_editor; ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i> <?php echo $button_language_editor; ?></a>
