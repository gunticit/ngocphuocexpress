              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'page_id') { ?>
                    <a href="<?php echo $sort_page_id; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_page_id; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_page_id; ?>"><?php echo $column_page_id; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($page['page_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $page['name']; ?><?php echo ($page['home']) ? ' - <strong>(' . $text_home . ')</strong>' : ''; ?></td>
                  <td class="text-right"><?php echo $page['page_id']; ?></td>
