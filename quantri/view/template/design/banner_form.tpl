        ...
        <script type="text/javascript"><!--
          ...
          function addImage() {
           ...
           <?php foreach ($languages as $language) { ?>
             ...
             html += '    <div class="input-group">';
             html += '      <span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><textarea  name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][description]"  placeholder="Mô tả" class="form-control" ></textarea>';
             html += '    </div>';
           <?php } ?>
           html += '  </td>';	
         ...
         <script type="text/javascript">
          <?php foreach ($languages as $language) { ?>
            $('#txt-cntbanner').summernote({height: 300});
          <?php } ?>
        </script>
        <?php echo $footer; ?>
