        ...
        <div class="panel-body">
          ...
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <label class="col-sm-2 control-label" for="input-background">Hình ảnh</label>
            ...
            <div class="form-group">
              ...
              <label class="col-sm-2 control-label" for="input-background2">Hình ảnh 2</label>

              <div class="col-sm-10">

                <a href="" id="thumb-background2" data-toggle="image" class="img-thumbnail">

                  <img src="<?php echo $thumb_bg2; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />

                </a>

                <input type="hidden" name="background2" value="<?php echo $background2; ?>" id="input-background2" />
