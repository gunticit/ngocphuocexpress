...
class ControllerModuleFeatured extends Controller {
	...
	public function index($setting) {
		...
		$this->document->addStyle('catalog/view/theme/default/stylesheet/jquery.simplyscroll.css');

		$this->document->addScript('catalog/view/javascript/jquery.simplyscroll.min.js');
