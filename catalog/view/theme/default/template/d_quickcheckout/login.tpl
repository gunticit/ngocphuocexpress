				...
				<form id="login_form">
					<div class="row">
						<div class="form-group col-lg-12 email">
							...
							<input type="text" name="email" value="<%= model.email %>" id="login_email" placeholder="<?php echo $entry_email; ?>" class="form-control box-input-1"/>
						</div>
						<div class="form-group  col-lg-12 password">
							<label class="control-label" for="login_password"><?php echo $entry_password; ?></label> 
							
							<input type="password" name="password" value="<%= model.password %>" id="login_password" placeholder="<?php echo $entry_password; ?>" class="form-control box-input-1"/>
