<div class="news-latest-module">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="box-title">
          <h3>TIN TỨC MỚI NHẤT CỦA CHÚNG TÔI</h3>
                ...
                <div class="border-box-new">
                  ...
                  <div class="image">
                    <a href="<?php echo $post['href']; ?>"> 
                      <img src="<?php echo $post['image']; ?>" alt="<?php echo $post['title']; ?>" title="<?php echo $post['title']; ?>" class="img-responsive" /> 
                    </a>
                  </div>
                  <?php } ?>
                  <div class="caption">
                    <h2 class="<?= $key == 0 ? 'weight-bold': ''; ?>"><a href="<?php echo $post['href']; ?>"><?php echo $post['title']; ?></a></h2>
                  </div>
                </div>
              <?php } ?>
            <?php } ?>
