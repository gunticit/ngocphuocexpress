<div id="pro-mega-menu-container">
	...
	<ul id='pro-mega-menu'>
		...
		?>
		<li class="root box-menu-1<?php if(isset($menu['active']) and $menu['active']==1) echo " active";?> <?php if($menu['activemega']==1) echo " mega-root";?>"><a href="<?php echo $menu['url']; ?>"><?php echo html_entity_decode(html_entity_decode($title[$lang_id])) ?></a>
			<?php
