...
<div class="col-sm-12"> 
  ...
  <div class="box-title">
    ...
    <img class="line-heading" src="image/line-pattern-copy.png" alt="">
  </div>
  ...
  <div id="carousel<?php echo $module; ?>" class="owl-carousel nxt">
    ...
    <div class="col-xs-12">
      ...
      <div class="border-box-new">
       <?php if ($banner['link']) { ?>
       <div class="image"> <a href="<?php echo $banner['link']; ?>"> <img src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" title="<?php echo $banner['title']; ?>" class="img-responsive"> </a></div>
       <?php } else { ?>
       <div class="image"><img src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" title="<?php echo $banner['title']; ?>" class="img-responsive"></div>
       <?php } ?>
       <div class="caption">
        <?php if ($banner['link']) { ?>
